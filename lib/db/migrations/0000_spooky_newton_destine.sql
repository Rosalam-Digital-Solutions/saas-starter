...
CREATE TABLE "teams" (
	...
	"billing_plan_name" varchar(50),
	"billing_status" varchar(30),
	"billing_current_period_end" timestamp,
	CONSTRAINT "teams_billing_customer_id_unique" UNIQUE("billing_customer_id"),
	CONSTRAINT "teams_billing_subscription_id_unique" UNIQUE("billing_subscription_id")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" serial PRIMARY KEY NOT NULL,
